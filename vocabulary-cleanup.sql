-- Delete ALL duplicates and keep only unique words per user
-- Run this in Supabase SQL Editor

-- Step 1: First, let's see what duplicates exist
SELECT word, user_id, COUNT(*) as count
FROM vocabulary
WHERE user_id = 'd0e40305-47d1-4ff5-9b74-b1691aceb98c'
GROUP BY word, user_id
HAVING COUNT(*) > 1;

-- Step 2: Delete all duplicates (keep none for now)
DELETE FROM vocabulary
WHERE user_id = 'd0e40305-47d1-4ff5-9b74-b1691aceb98c';

-- Step 3: Insert unique words
